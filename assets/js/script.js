...
function iniciarMap() {
  // Obtén la referencia al elemento HTML donde se mostrará el mapa
  var mapElement = document.getElementById('map');

  // Configuración inicial del mapa centrado en una ubicación específica
  var initialCoord = { lat: 21.42457497410521, lng: -104.89859487671093 };
  ...
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      // Ajusta la vista del mapa para incluir ambos marcadores
      var bounds = new google.maps.LatLngBounds();
      bounds.extend(initialMarker.getPosition());
